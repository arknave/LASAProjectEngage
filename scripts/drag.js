...
(function($){
    var drag_target, potential_drop_targets, drop_target, drop_rects, start_position, timer, cloned, dragging, current_position, distance, start_parent, drag_placeholder;
    ...
    function handle_drop(){
        ...
        if (drop_target && drop_target.length){
            ...
            if (drag_target.block_type() === 'step'){
                ...
                // console.log('trying to drop: into %s', drop_target.int_name());
